...
<section class="categories">
   <?php
      ...
      echo '<a href="shop.php" class="category-btn ' . ($filter_category == '' ? 'active' : '') . '">All</a>';
      while ($cat = mysqli_fetch_assoc($categories)) {
         $cat_name = $cat['category'];
         echo '<a href="shop.php?category=' . urlencode($cat_name) . '" class="category-btn ' . ($filter_category == $cat_name ? 'active' : '') . '">' . htmlspecialchars($cat_name) . '</a>';
      }
   ?>
</section>
...
<section class="products">
   ...
   <div class="box-container">
      <?php
         ...
         if ($filter_category) {
            $query .= " WHERE category='" . mysqli_real_escape_string($conn, $filter_category) . "'";
         }
